...
let observerSection1Figure1 = new ElementParallax(document.querySelector('.figure-1'), -0.24);
let observerSection1Figure2 = new ElementParallax(document.querySelector('.figure-2'), -0.28);
let observerSection1Figure3 = new ElementParallax(document.querySelector('.figure-3'), -0.26);
